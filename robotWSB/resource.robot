...
${PROCEEDtoCHECKOUT}    xpath: //span[contains(text(),'Proceed to checkout')]
${PROCEEDtoCHECKOUT2}    xpath: /html/body/div/div[2]/div/div[3]/div/p[2]/a[1]/span
${PROCEEDtoCHECKOUT3}   xpath: /html/body/div/div[2]/div/div[3]/div/form/p/button/span
${PROCEEDtoCHECKOUT4}   xpath: /html/body/div/div[2]/div/div[3]/div/form/p/button
${PROCEEDtoCHECKOUT5}   xpath: /html/body/div/div[2]/div/div[3]/div/div/form/p/button/span
...
go through checkout
    scroll to element    ${proceedtocheckout4}
    click element    ${proceedtocheckout4}
    click element    ${tos}
    click element    ${PROCEEDTOCHECKOUT5}
